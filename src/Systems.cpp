...
Motor left4Bar(left4BarPort, pros::E_MOTOR_GEARSET_18, left4BarReversed, pros::E_MOTOR_ENCODER_DEGREES);
Motor right4Bar(right4BarPort, pros::E_MOTOR_GEARSET_18, right4BarReversed, pros::E_MOTOR_ENCODER_DEGREES);

Motor clamp(clampPort, pros::E_MOTOR_GEARSET_36, clampReversed, pros::E_MOTOR_ENCODER_DEGREES);
